...
\mycbox{black} & Identify M & Determines properties of magic item.\\
...
\mycbox{black} & Arcane Lock M & Magically locks a portal or chest.\\
...
\mycbox{black} & Continual Flame M & Makes a permanent, heatless torch.\\
...
\mycbox{black} & Fire Trap M & Opened object deals 1d4 damage +1/level.\\
...
\mycbox{black} & Stoneskin M & Ignore 10 points of damage per attack.\\
...
\mycbox{black} & Scrying F & Spies on subject from a distance.\\
...
\mycbox{black} & Secret Chest F & Hides expensive chest on Ethereal Plane; you retrieve it at will.\\
...
\mycbox{black} & Permanency X & Makes certain spells permanent.\\
\end{tabularx}
...
\mycbox{black} & Instant Summons M & Prepared object appears in your hand.\\
\mycbox{black} & Mage’s Magnificent Mansion F & Door leads to extradimensional mansion.\\
\mycbox{black} & Phase Door & Creates an invisible passage through wood or stone.\\
\mycbox{black} & Plane Shift F & As many as eight subjects travel to another plane.\\
...
\mycbox{black} & Vision M X & As legend lore, but quicker and strenuous.\\
...
\mycbox{black} & Protection from Spells M F & Confers +8 resistance bonus.\\
...
\mycbox{black} & Trap the Soul M F & Imprisons subject within gem.\\
...
\mycbox{black} & Binding M & Utilizes an array of techniques to imprison a creature.\\
...
\mycbox{black} & Symbol of Insanity M & Triggered rune renders nearby creatures insane.\\
\mycbox{black} & Sympathy F & Object or location attracts certain creatures.\\
...
\mycbox{black} & Clone M F & Duplicate awakens when original dies.\\
\mycbox{black} & Create Greater Undead M & Create shadows, wraiths, spectres, or devourers.\\
\mycbox{black} & Horrid Wilting & Deals 1d6/level damage within 30 ft.\\
\mycbox{black} & Symbol of Death M & Triggered rune slays nearby creatures.\\
...
\mycbox{black} & Temporal Stasis M & Puts subject into suspended animation.\\
\end{tabularx}
